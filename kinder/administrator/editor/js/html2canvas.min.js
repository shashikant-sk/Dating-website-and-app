...
!(function (A, e) {
  ...
  return (function (A) {
        ...
        U = (function () {
          function A(e) {
            ...
            var t = Array.isArray(e)
                ? Q(e)
                : a(e) || c(e) || u(e) || w(e) || o(e) || [0, 0, 0, null],
              n = r(t, 4),
              B = n[0],
              s = n[1],
              i = n[2],
    ...
    function (A, e, t) {
      ...
      var n = (e.LENGTH_TYPE = { PX: 0, PERCENTAGE: 1 }),
        B = (function () {
          function A(e) {
            !(function (A, e) {
              if (!(A instanceof e))
              ...
              (this.type =
                "%" === e.substr(e.length - 1) ? n.PERCENTAGE : n.PX);
            var t = parseFloat(e);
              ...
              topRightInner:
                a > 0 || s > 0
                  ? c(
                      ...
                      A.top + e[0].borderWidth,
                      g > A.width + e[3].borderWidth ? 0 : a - e[3].borderWidth,
                      s - e[0].borderWidth,
                      i.TOP_RIGHT
                    )
                  : new n.default(
      ...
      var c = (e.BACKGROUND_REPEAT = {
        ...
        U =
          ((e.calculateBackgroundSize = function (A, e, t) {
            ...
            return (
              a[0].value && (r = a[0].value.getAbsoluteValue(t.width)),
              a[0].size === l.AUTO && a[1].size === l.AUTO
                ? (n = e.height)
                : a[1].size === l.AUTO
                ? (n = (r / e.width) * e.height)
                : a[1].value && (n = a[1].value.getAbsoluteValue(t.height)),
          ...
          function A(e, t, r, B) {
            ...
            "IMG" === e.tagName &&
              e.addEventListener("load", function () {
                (y.bounds = (0, K.parseBounds)(e, L, _)),
                  (y.curvedBounds = (0, K.parseBoundCurves)(
                    y.bounds,
                    y.style.border,
              ...
              (this.image = b(e, r)),
              (this.bounds = O
                ? (0, T.reformatInputBounds)((0, K.parseBounds)(e, L, _))
                : (0, K.parseBounds)(e, L, _)),
            ...
            r(A, [
              {
                ...
                value: function () {
                  ...
                  return this.style.overflow !== g.OVERFLOW.VISIBLE
                    ? A.concat([
              ...
              },
              {
                ...
                value: function () {
                  return (
                    !(0, B.contains)(this.style.display, i.DISPLAY.NONE) &&
              ...
              },
              {
                ...
                value: function () {
                  return (
                    (0, B.contains)(this.style.display, i.DISPLAY.INLINE) ||
                    (0, B.contains)(
                      this.style.display,
                      i.DISPLAY.INLINE_BLOCK
                    ) ||
                    (0, B.contains)(
                      this.style.display,
                      i.DISPLAY.INLINE_FLEX
                    ) ||
                    (0, B.contains)(
                      this.style.display,
                      i.DISPLAY.INLINE_GRID
                    ) ||
                    (0, B.contains)(
                      this.style.display,
                      i.DISPLAY.INLINE_LIST_ITEM
                    ) ||
                    (0, B.contains)(this.style.display, i.DISPLAY.INLINE_TABLE)
                  );
                },
              },
              {
      ...
      var r = t(23),
        ...
        B = {
          ...
          get SUPPORT_CORS_XHR() {
            ...
            return (
              Object.defineProperty(B, "SUPPORT_CORS_XHR", { value: A }), A
            );
          },
        };
      e.default = B;
        ...
        return null === e
          ...
          : {
              ...
              textDecorationColor: A.textDecorationColor
                ? new r.default(A.textDecorationColor)
                : null,
    ...
    function (A, e, t) {
      ...
      var n = (e.BORDER_STYLE = { NONE: 0, SOLID: 1 }),
        B = (e.BORDER_SIDES = { TOP: 0, RIGHT: 1, BOTTOM: 2, LEFT: 3 }),
          ...
          for (var c = 0; o > 0 && c <= 4; c++) {
            ...
            0 === l && (0, r.contains)(s, 1) && "" !== i
              ...
              : l > 1 ||
                ...
                (1 === l && 1 === c && (0, r.contains)(s, 4) && A > 100) ||
                          ...
                          ? n
                              ...
                              .forEach(function (e) {
                                (a.ctx.shadowColor = e.color.toString()),
                                  (a.ctx.shadowOffsetX =
                                    e.offsetX * a.options.scale),
                                  (a.ctx.shadowOffsetY =
                                    e.offsetY * a.options.scale),
                        ...
                        r.textDecorationLine.forEach(function (e) {
                          switch (e) {
                            case B.TEXT_DECORATION_LINE.UNDERLINE:
                              var r =
                                a.options.fontMetrics.getMetrics(t).baseline;
                              a.rectangle(
                                A.bounds.left,
                            ...
                            case B.TEXT_DECORATION_LINE.LINE_THROUGH:
                              var n =
                                a.options.fontMetrics.getMetrics(t).middle;
                              a.rectangle(
                                A.bounds.left,
      ...
      var s = (e.TextBounds = function A(e, t) {
        ...
        i = function (A, e, t, n, B) {
          ...
          return (
            a.setStart(A, e),
            a.setEnd(A, e + t),
            r.Bounds.fromClientRect(a.getBoundingClientRect(), n, B)
          );
        };
    },
    function (A, e, t) {
      ...
      e.breakWords = function (A, e) {
        for (
          var t = (0, r.LineBreaker)(A, {
              ...
              wordBreak:
                e.style.overflowWrap === n.OVERFLOW_WRAP.BREAK_WORD
                  ? "break-word"
                  : e.style.wordBreak,
            }),
            B = [],
    ...
    function (A, e, t) {
      ...
      e.Proxy = function (A, e) {
        ...
        return new Promise(function (n, B) {
          var a =
              r.default.SUPPORT_CORS_XHR && r.default.SUPPORT_RESPONSE_TYPE
                ? "blob"
                : "text",
            s = r.default.SUPPORT_CORS_XHR
              ? new XMLHttpRequest()
              : new XDomainRequest();
          if (
            ((s.onload = function () {
    ...
    function (A, e, t) {
      ...
      e.renderElement = function A(e, t, Q) {
        var w = e.ownerDocument,
          ...
          g = w.documentElement
            ? new u.default(getComputedStyle(w.documentElement).backgroundColor)
            : l.TRANSPARENT,
          C = w.body
            ? new u.default(getComputedStyle(w.body).backgroundColor)
            : l.TRANSPARENT,
          d =
            e === w.documentElement
              ? g.isTransparent()
        ...
        return (
          ...
          return s
            ? (function (A) {
                return A.inlineFonts(w)
                  ...
                  .then(function () {
                    var r = new a.default(A.documentElement),
                      ...
                      i =
                        "HTML" === e.tagName || "BODY" === e.tagName
                          ? (0, o.parseDocumentSize)(w)
                          : (0, o.parseBounds)(e, B, s),
                      c = i.width,
                      l = i.height,
                      u = i.left,
                      U = i.top;
                    return r.render({
                      ...
                      width:
                        "number" == typeof t.width ? t.width : Math.ceil(c),
                      height:
                        "number" == typeof t.height ? t.height : Math.ceil(l),
              ...
              })(new i.DocumentCloner(e, t, Q, !0, A))
      ...
      e.parseTextShadow = function (A) {
        ...
        for (
          var e = "",
            ...
            o = null,
            i = function () {
              e.length && (t ? B.push(parseFloat(e)) : (o = new r.default(e))),
                (t = !1),
                (e = "");
            },
            c = function () {
      ...
      var o = (e.LETTER_NUMBER_MODIFIER = 50),
        ...
        G = function (A, e, t, r, n) {
          ...
          if (
            ...
            return L;
          if (
            (o === E && -1 !== [T, p, N].indexOf(b)) ||
            (-1 !== [T, p, N].indexOf(o) && b === f)
          )
            return L;
          if (
            (-1 !== M.indexOf(o) && -1 !== P.indexOf(b)) ||
            (-1 !== P.indexOf(o) && -1 !== M.indexOf(b))
          )
            return L;
          if (
            (-1 !== [E, f].indexOf(o) &&
              (b === F || (-1 !== [C, l].indexOf(b) && e[s + 1] === F))) ||
            (-1 !== [C, l].indexOf(o) && b === F) ||
            (o === F && -1 !== [F, h, d].indexOf(b))
          )
            return L;
          ...
          if (
            (m === o && -1 !== [m, v, I, K].indexOf(b)) ||
            (-1 !== [v, I].indexOf(o) && -1 !== [v, y].indexOf(b)) ||
            (-1 !== [y, K].indexOf(o) && b === y)
          )
            return L;
          if (
            (-1 !== z.indexOf(o) && -1 !== [U, f].indexOf(b)) ||
            (-1 !== z.indexOf(b) && o === E)
          )
            return L;
          ...
          if (
            (-1 !== M.concat(F).indexOf(o) && b === C) ||
            (-1 !== M.concat(F).indexOf(b) && o === Q)
          )
            return L;
          if (41 === o && 41 === b) {
                  ...
                  value: function (A) {
                    ...
                    if (A >= 0) {
                      if (A < 55296 || (A > 56319 && A <= 65535))
                        return (
                          (e = ((e = this.index[A >> B]) << s) + (A & l)),
                          this.data[e]
                        );
                      if (A <= 65535)
                        return (
                          (e =
                            ((e = this.index[i + ((A - 55296) >> B)]) << s) +
                            (A & l)),
                          this.data[e]
                        );
                      if (A < this.highStart)
          ...
          n(A, [
                    ...
                    if (
                      ...
                      if (t) {
                        ...
                        n > 0 &&
                          a > 0 &&
                          e.target.clip(
                            [(0, B.calculatePaddingBoxPath)(A.curvedBounds)],
                            function () {
                              e.target.drawImage(
                                t,
                                new B.Bounds(0, 0, n, a),
                                r
                              );
                            }
                          );
              ...
              value: function (A) {
                var e = this,
                  ...
                  r = A.style.border.some(function (A) {
                    return (
                      A.borderStyle !== i.BORDER_STYLE.NONE &&
                      !A.borderColor.isTransparent()
                    );
                  }),
                  n = function () {
                    var r = (0, o.calculateBackgroungPaintingArea)(
                      A.curvedBounds,
                    ...
                    t &&
                      ...
                      A.style.border.forEach(function (t, r) {
                        t.borderStyle === i.BORDER_STYLE.NONE ||
            ...
            },
            {
              ...
              value: function (A, e) {
                ...
                if (t) {
                  var r = (0, o.calculateBackgroungPositioningArea)(
                    ...
                    a = (0, o.calculateBackgroundRepeatPath)(
                      e,
                      B,
                      n,
                      r,
            ...
            },
            {
              ...
              value: function (A, e) {
                var t = (0, o.calculateBackgroungPositioningArea)(
                    A.style.background.backgroundOrigin,
                    A.bounds,
                    A.style.padding,
                    A.style.border
        ...
        H = function (A, e, t) {
          ...
          r &&
            ...
            r[7]
              ...
              : void 0 !== r[8] &&
                (s.x = (0, a.calculateLengthFromValueWithUnit)(A, r[8], r[9])),
            r[10]
          ...
          switch (A) {
            case "closest-side":
              e === C.CIRCLE
                ...
                : e === C.ELLIPSE &&
                  ((s = Math.min(Math.abs(B), Math.abs(B - n.width))),
            ...
            case "farthest-side":
              e === C.CIRCLE
                ...
                : e === C.ELLIPSE &&
                  ((s = Math.max(Math.abs(B), Math.abs(B - n.width))),
            ...
            n(A, [
              {
                ...
                value: function (A) {
                  ...
                  if (this.inlineImages && A) {
                    var t = A.style;
                    Promise.all(
                      (0, i.parseBackgroundImage)(t.backgroundImage).map(
                        function (A) {
                          return "url" === A.method
                            ? e.resourceLoader
                ...
                value: function (A) {
                  ...
                  if (A instanceof HTMLIFrameElement) {
                    ...
                    var a = (0, B.parseBounds)(A, 0, 0),
                      ...
                      i = a.height;
                    return (
                      (this.resourceLoader.cache[n] = K(A, this.options)
                        .then(function (A) {
                          return e.renderer(
                            A,
                            {
              ...
              },
              {
                ...
                value: function (A) {
                  ...
                  for (
                    var a = (0, l.parseCounterReset)(r, this.pseudoContentData),
                  ...
                  if (
                    ((0, l.popCounters)(a, this.pseudoContentData),
                    A instanceof t.HTMLElement && e instanceof t.HTMLElement)
                  )
                    switch (
                      (n && this.inlineAllImages(C(A, e, n, s, d)),
          ...
          try {
            ...
            return e.proxy
              ? (0, a.Proxy)(A.src, e)
                  ...
                  .then(function (e) {
                    return T(A.ownerDocument, (0, B.parseBounds)(A, 0, 0)).then(
                      function (A) {
              ...
              var B = n.contentWindow,
                ...
                c = m(n).then(function () {
                  ...
                  var t = Promise.resolve([
                    ...
                    s = r.onclone;
                  return a.clonedReferenceElement instanceof B.HTMLElement ||
                ...
                if (!U(A) || n.default.SUPPORT_SVG_DRAWING) {
                  ...
                  if (!this.isSameOrigin(A)) {
                    if ("string" == typeof this.options.proxy)
                      return (
                        (this.cache[A] = (0, B.Proxy)(A, this.options).then(
                          function (A) {
            ...
            },
            {
              ...
              value: function (A, e, t) {
                ...
                return (
                  (this.cache[A] =
                    Q(e) && !U(e)
                      ? n.default.SUPPORT_BASE64_DRAWING(e).then(B)
                      : B(!0)),
                  A
                );
              },
                ...
                case '"':
                  B
                    ...
                    : ((n = !n),
                      a ||
                        n ||
                        (t.push({ type: s.STRING, value: o }), (o = "")));
                  break;
                case "\\":
                  B ? ((o += Q), (B = !1)) : (B = !0);
                  break;
